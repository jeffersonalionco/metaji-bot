...
global.MyApiRestApikey = "GroupMetaJI";

global.MyApiRestBaseUrl2 = "https://api-groupmetaji.koyeb.app";

global.MyApiRestBaseUrl3 = "https://api-groupmetaji.onrender.com";
...
global.lolkeysapi = ['GataDiosV3']; // ['GroupMetaJI_2']
...
global.APIKeys = {
  "https://api.xteam.xyz": "GroupMetaJI",
  "https://api.stellarwa.xyz": "GroupMetaJI",
...
watchFile(file, () => {
  ...
  void sendMetajiExecutionLog(global.conn, "Update 'api.js'", {
    source: 'api.js',
    event: 'file-update',
  }).catch(() => {});

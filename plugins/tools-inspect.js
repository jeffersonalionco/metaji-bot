...
const handler = async (m, {conn, text}) => {
  ...
  if (!code) throw '*[❗] Digite o link de um grupo do WhatsApp*';
...
const extractGroupMetadata = (result) => {
  ...
  const metadata = {
    ...
    creation: new Date(+group.attrs.creation * 1000).toLocaleString('pt-BR', {timeZone: 'America/Sao_Paulo'}),

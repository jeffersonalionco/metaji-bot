const minarFrases = [
  'Que pro 😎 você minerou',
  '🌟✨ Legal!! Você recebe',
  'WOW!! você é um ótimo Minerador ⛏️ Recebe',
  'Você minerou!!',
  '😲 Conseguiu minerar a quantidade de',
  'Suas ganâncias vão subir porque você minerou',
  '⛏️⛏️⛏️⛏️⛏️ Minerando',
  '🤩 SIM!!! AGORA VOCÊ TEM',
  'A sorte da mineração está do seu lado, por isso recebe',
  '😻 A sorte de minerar',
  '♻️ Sua missão foi cumprida, você minerou',
  '⛏️ A mineração te beneficiou com',
  '🛣️ Você encontrou um local e minerando lá recebe',
  '👾 Graças à mineração suas ganâncias aumentam',
...
let handler = async (m, {conn, isPrems}) => {
  ...
  const minar = `${pickRandom(minarFrases)}`;

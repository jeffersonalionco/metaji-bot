...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  if (!args[0]) throw `*[❗] Informe o usuário do Instagram. Exemplo:* ${usedPrefix + command} luisitocomunica*`;
  ...
  const iggs = `_*${labels[0]}*_\n
${labels[1]} ${json.fullname}
${labels[2]} ${json.username}
${labels[3]} ${json.followers}
${labels[4]} ${json.following}
${labels[5]} ${json.post}
${labels[6]} https://instagram.com/${json.username.replace(/^@/, '')}
${labels[7]}\n${json.bio}`.trim();

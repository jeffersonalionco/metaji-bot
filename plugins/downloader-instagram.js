...
const handler = async (m, { conn, args, command, usedPrefix }) => {
  if (!args[0]) throw `_*< BAIXAR - INSTAGRAM />*_\n\n*[ ℹ️ ] Digite um link do Instagram.*\n\n*[ 💡 ] Exemplo:* _${usedPrefix + command} https://www.instagram.com/reel/C8sWV3Nx_GZ/?igsh=MWZoeTY2cW01Nzg1bQ==`;
  try {

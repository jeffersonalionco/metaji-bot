const handler = async (m, {isPrems, conn}) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastcofre < 86400000) throw `[❗] Você já reclamou seu cofre\nVolte em *${msToTime(time - new Date())}* para reclamar novamente`;

...
const handler = async (m, { conn, args, command, usedPrefix, text }) => {
  ...
  if (!args[0]) throw `*[❗] Informe um link válido do XVideos. Exemplo:* ${usedPrefix + command} https://www.xvideos.com/video70389849/exemplo*`;
  try {
    conn.reply(m.chat, '*[❗] O vídeo está sendo processado, aguarde um momento...*\n\n_O tempo de envio depende do peso e duração do vídeo*', m);
    ...
    throw `*[❗] Erro. Tente novamente.*\n\n*Verifique se o link é similar a:*\n*◉ https://www.xvideos.com/video70389849/exemplo*`;
  }
};
handler.tags = ['nsfw'];
